...
Pod::Spec.new do |s|
  s.name         = "ActiveLayerContrast"
  s.version      = "1.0.0"
  s.summary      = "iOS ActiveLayerContrast Module."
  s.author       = { "ActiveLayerContrast" => "ActiveLayerContrast.me" }
  s.homepage     = "ActiveLayerContrast"
  s.source       = { :git => "http://ActiveLayerContrast.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'ActiveLayerContrast/Classes/**/*'
  s.resources = "ActiveLayerContrast/Resources/*.bundle"
