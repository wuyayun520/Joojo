...
open class TitleView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = TitleView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
