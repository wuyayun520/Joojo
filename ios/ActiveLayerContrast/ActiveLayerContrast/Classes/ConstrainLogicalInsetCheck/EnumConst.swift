...
enum InsideWhenDistributionChange {
    //: case Unknown
    case Unknown
    //: case Login
    case Login
...
enum LikeTrack: String {
    //: case FacebookLogin
    case FacebookLogin // FB登录
    //: case AppleLogin
    case AppleLogin // Apple登陆
    //: case SnapChatLogin
    case SnapChatLogin // SC登陆
    //: case GoogleLogin
...
enum ResolveTakeSinceCycle: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
@objc enum SophisticatedMultiple: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum EasyGlobal: Int {
    //: case Unavailable = 0
