...
fileprivate let appEvolutionDelayTitle:[UInt8] = [0xef,0xe8,0xef,0xf2,0xae,0xe5,0xe9,0xe2,0xe3,0xf4,0xbc,0xaf,0xa6,0xee,0xe7,0xf5,0xa6,0xe8,0xe9,0xf2,0xa6,0xe4,0xe3,0xe3,0xe8,0xa6,0xef,0xeb,0xf6,0xea,0xe3,0xeb,0xe3,0xe8,0xf2,0xe3,0xe2]

private func alongAgreement(first num: UInt8) -> UInt8 {
    return num ^ 134
}

/*: "Cancel" :*/
fileprivate let kIconUrl:[Character] = ["C","a","n","c","e","l"]

/*: "Sure" :*/
fileprivate let dataFeatureData:String = "Sureleave enormous roll"
...
class VerticalView: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: appEvolutionDelayTitle.map{alongAgreement(first: $0)}, encoding: .utf8)!)
    }

    //: private func setupView() {
    private func midAndCore() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(whoCoalition))
        ...
        cancelButton.setTitle((String(kIconUrl)).localized, for: .normal)
        //: cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: cancelButton.setTitleColor(UIColor.black, for: .normal)
        cancelButton.setTitleColor(UIColor.black, for: .normal)
        //: cancelButton.addTarget(self, action: #selector(cancelClick(button:)), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(alongLock(button:)), for: .touchUpInside)
        ...
        confirmButton.setTitle((String(dataFeatureData.prefix(4))).localized, for: .normal)
        //: confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: confirmButton.setTitleColor(UIColor.black, for: .normal)
        confirmButton.setTitleColor(UIColor.black, for: .normal)
        //: confirmButton.addTarget(self, action: #selector(confirmClick(button:)), for: .touchUpInside)
        confirmButton.addTarget(self, action: #selector(domainFront(button:)), for: .touchUpInside)
    ...
    private func restrictionVersus() {
    ...
    @objc func alongLock(button: UIButton) {
        //: dismissView()
        whoCoalition()
    }

    //: @objc func confirmClick(button: UIButton) {
    @objc func domainFront(button: UIButton) {
        //: dismissView()
        whoCoalition()
    }
