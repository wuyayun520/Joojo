...
fileprivate let mainWrapMessage:[UInt8] = [0xb6,0xbb,0xb6,0xc1,0x75,0xb0,0xbc,0xb1,0xb2,0xbf,0x87,0x76,0x6d,0xb5,0xae,0xc0,0x6d,0xbb,0xbc,0xc1,0x6d,0xaf,0xb2,0xb2,0xbb,0x6d,0xb6,0xba,0xbd,0xb9,0xb2,0xba,0xb2,0xbb,0xc1,0xb2,0xb1]

fileprivate func constantRadio(camera num: UInt8) -> UInt8 {
...
/*: "icon_lounge" :*/
fileprivate let show_warnStr:[Character] = ["i","c","o","n","_","l","o","u","n","g","e"]

/*: "#777777" :*/
fileprivate let showContinuingSaleName:[Character] = ["#","7"]
fileprivate let notiUnlessPath:String = "77777"

/*: "UID: :*/
fileprivate let userRomanFormat:String = "UID:eager listener drown don"
...
class LevelTop: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: mainWrapMessage.map{constantRadio(camera: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.road(name: (String(show_warnStr)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.font = UIFont.bagUniform(type: .Regular, fontSize: 15)
        //: lab.textColor = UIColor(hex: "#777777")
        lab.textColor = UIColor(hex: (String(showContinuingSaleName) + notiUnlessPath.capitalized))
        //: return lab
        return lab
        //: }()
    }()
...
extension LevelTop {
    ...
    func sumerval(model: DespiteWrap) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.fireIn(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.appTitleColor()
        nicknameLab.textColor = model.loungePlus ? .clickForRace() : .sharkHighlightMaintain()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(userRomanFormat.prefix(4))) + "\(model.uid)"
