...
@objc public enum ContextLevel: UInt {
...
@objc public enum ThresholdCorner: UInt {
 ...
 */
//: @objcMembers public class EmbraceShadow: TCommonCellData {
@objcMembers public class EmbraceShadow: ChartEmptyPop {
    ...
    public var direction: ThresholdCorner = .MsgDirectionIncoming
    ...
    public var translateStatus: ContextLevel = .MsgTranslate_init
    ...
    public var msgModel: ItemModel = ItemModel()
    ...
    public var cellLayout: BulletUntil!
    ...
    public init(direction: ThresholdCorner) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.franklyBounce()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = BulletUntil(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = BulletUntil(isIncomming: false)
    ...
    public override func anonymousDirect(_ width: CGFloat) -> CGFloat {
