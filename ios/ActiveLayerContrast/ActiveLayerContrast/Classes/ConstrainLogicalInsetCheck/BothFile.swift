...
fileprivate let constLaunchUrl:[UInt8] = [0xc4,0xc3,0xc4,0xd9,0x85,0xce,0xc2,0xc9,0xc8,0xdf,0x97,0x84,0x8d,0xc5,0xcc,0xde,0x8d,0xc3,0xc2,0xd9,0x8d,0xcf,0xc8,0xc8,0xc3,0x8d,0xc4,0xc0,0xdd,0xc1,0xc8,0xc0,0xc8,0xc3,0xd9,0xc8,0xc9]

/*: "JXBannerCellID" :*/
fileprivate let data_versusTitle:String = "pass ret youJXBan"
fileprivate let user_inspectPath:[Character] = ["n","e","r","C","e","l","l","I","D"]
...
class BothFile: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: constLaunchUrl.map{$0^173}, encoding: .utf8)!)
    }
...
extension BothFile: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(data_versusTitle.suffix(5)) + String(user_inspectPath)))
    }
...
extension BothFile {
    ...
    func nana(bannerData: [PushMaximum]) {
...
extension BothFile {
    ...
    private func afterFractionYesterday() {
