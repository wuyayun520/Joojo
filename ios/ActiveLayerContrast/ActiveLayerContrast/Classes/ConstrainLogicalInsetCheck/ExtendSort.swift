...
fileprivate let notiAmHideNormString:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class ExtendSort: UIView {
    //: private var giftSendItem = [TalkingGiftNumArrModel()]
    private var giftSendItem = [BackgroundPlatform()]
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: notiAmHideNormString.reversed(), encoding: .utf8)!)
    }
    ...
    func processing(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.depth()
    ...
    func doingceWindow(frame: CGRect) {
        //: self.frame = frame
        self.frame = frame
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.doingShelter(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.doingShelter(253, 170, 52, 1).cgColor, // 深黄
        ]
