...
fileprivate let mainMinimizeFamilyRaceTitle:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "UITableViewCellContentView" :*/
fileprivate let data_constructFormat:[Character] = ["U","I","T","a","b","l","e","V","i","e","w","C","e","l","l","C","o","n","t","e","n","t","V","i","e","w"]
...
class ActivityPrior: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(lastRemark))
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: mainMinimizeFamilyRaceTitle.reversed(), encoding: .utf8)!)
    }
    ...
    func offToday() {
        ...
        self.chemist()?.view.endEditing(true)
...
extension ActivityPrior: UIGestureRecognizerDelegate {
    ...
    func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        ...
        if classStr == (String(data_constructFormat)) {
            //: return false
            return false
            //: }else {
        } else {
