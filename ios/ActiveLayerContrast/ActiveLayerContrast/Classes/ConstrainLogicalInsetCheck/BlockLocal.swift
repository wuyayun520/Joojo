...
fileprivate let data_removeString:[UInt8] = [0x93,0x94,0x93,0x8e,0xd2,0x99,0x95,0x9e,0x9f,0x88,0xc0,0xd3,0xda,0x92,0x9b,0x89,0xda,0x94,0x95,0x8e,0xda,0x98,0x9f,0x9f,0x94,0xda,0x93,0x97,0x8a,0x96,0x9f,0x97,0x9f,0x94,0x8e,0x9f,0x9e]

private func readyTic(body num: UInt8) -> UInt8 {
    return num ^ 250
}
...
class BlockLocal: GestureLast {
    //: var giftData: FeatureOccasion?
    var giftData: FeatureOccasion?
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: data_removeString.map{readyTic(body: $0)}, encoding: .utf8)!)
    }
