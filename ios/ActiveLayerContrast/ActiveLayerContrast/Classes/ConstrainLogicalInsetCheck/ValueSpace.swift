...
class ValueSpace: NSObject {
    ...
    deinit {
        ...
        self.galleryLabelHighlightUp()
    }
}

// MARK: - Public Event
//: extension TalkingVideoInitivCallTool {
extension ValueSpace {
    /// 释放资源
    //: func shouldReleaseAllResource() {
    func galleryLabelHighlightUp() {
        //: destoryTRTCView()
        errThe()
    }
    ...
    func visibleCommon(_ frontCamera: Bool) {
        ...
        self.customOf(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func productDoinger(_ openCamera: Bool) {
        ...
        self.asReport(isOpen: openCamera)
    }
    ...
    func okDeploy() {
        ...
        DispatchQueue.main.async {
            ...
            self.closed(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension ValueSpace {
    ...
    private func customOf(front: Bool) {
    ...
    private func asReport(isOpen: Bool) {
        //: if isOpen {
        if isOpen {
...
extension ValueSpace {
    ...
    func frequencyBring() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(switchdChannel(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(thePrompt(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(everyImplement(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(visibleFirst(notif:)),
    ...
    @objc private func switchdChannel(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func thePrompt(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func everyImplement(notif: Notification) {
    ...
    @objc func visibleFirst(notif: Notification) {
