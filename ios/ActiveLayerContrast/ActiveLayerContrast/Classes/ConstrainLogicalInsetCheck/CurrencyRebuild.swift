...
fileprivate let data_commitFormat:[UInt8] = [0xfd,0x2,0xfd,0x8,0xbc,0xf7,0x3,0xf8,0xf9,0x6,0xce,0xbd,0xb4,0xfc,0xf5,0x7,0xb4,0x2,0x3,0x8,0xb4,0xf6,0xf9,0xf9,0x2,0xb4,0xfd,0x1,0x4,0x0,0xf9,0x1,0xf9,0x2,0x8,0xf9,0xf8]

fileprivate func directEnablely(frame num: UInt8) -> UInt8 {
...
class CurrencyRebuild: UITextView {
    /// 占位文字
    //: var placeholder: String?
    var placeholder: String?
    /// 占位文字颜色
    //: var placeholderColor: UIColor? = UIColor.appValueDetailColor()
    var placeholderColor: UIColor? = UIColor.beforePainter()
...
//    var PlaceholderInsets: UIEdgeInsets = UIEdgeInsets(top: 5, left: 5, bottom: 5, right: 5)
    ...
    override init(frame: CGRect, textContainer: NSTextContainer?) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(asStatus(_:)), name: UITextView.textDidChangeNotification, object: nil)
    }
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: data_commitFormat.map{directEnablely(frame: $0)}, encoding: .utf8)!)
    }
    ...
    @objc func asStatus(_ note: Notification) {
        // 会重新调用drawRect:方法
