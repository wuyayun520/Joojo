...
/*: ".png" :*/
fileprivate let mainRelatedTitle:[Character] = [".","p","n","g"]
...
//: @objcMembers public class WantText: TalkingChatMsgBaseCellData {
@objcMembers public class WantText: ReductionProfile {
    ...
    override public var msgModel: ItemModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.corruptionDetect(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func consumption(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(user_availableValue)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + ChartShowSceneScientific.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + ChartShowSceneScientific.share.loginUserMode.userID + (String(mainRelatedTitle))
        ...
        let imageData = UIImage.sign(image, estimatedClean: 2 * 1024)
