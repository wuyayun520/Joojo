...
fileprivate let show_endTitle:[UInt8] = [0x65,0x62,0x65,0x78,0x24,0x6f,0x63,0x68,0x69,0x7e,0x36,0x25,0x2c,0x64,0x6d,0x7f,0x2c,0x62,0x63,0x78,0x2c,0x6e,0x69,0x69,0x62,0x2c,0x65,0x61,0x7c,0x60,0x69,0x61,0x69,0x62,0x78,0x69,0x68]

/*: "icon_coinxxx" :*/
fileprivate let const_consumptionMsg:[Character] = ["i","c"]
fileprivate let mainControlRemainFormat:String = "on_cotap could consumer additional"

/*: "icon_gift_num_bg" :*/
fileprivate let k_conPath:[Character] = ["i","c","o","n","_","g","i","f","t","_","n","u"]
fileprivate let showAgoString:String = "m_bgtransform track analyze"
...
// __CLOSE_PRINT__
//
//  ContainerTableDisabledImplement.swift
//  AbroadTalking
//
...
class ContainerTableDisabledImplement: UICollectionViewCell {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        fatalError(String(bytes: show_endTitle.map{$0^12}, encoding: .utf8)!)
    }
    ...
    lazy var nameLB: UILabel = {
        ...
        lb.font = UIFont.bagUniform(type: .Regular, fontSize: 10)
        //: lb.textColor = .white
        lb.textColor = .white
    ...
    lazy var priceBtn: KeepPurple = {
        //: let btn = TalkingButton.init()
        let btn = KeepPurple()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Regular, fontSize: 10)
        btn.titleLabel?.font = UIFont.bagUniform(type: .Regular, fontSize: 10)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coinxxx"), for: .normal)
        btn.setImage(UIImage.road(name: (String(const_consumptionMsg) + String(mainControlRemainFormat.prefix(5)) + "inxxx")), for: .normal)
    ...
    lazy var numBgView: UIImageView = {
        ...
        let imag = UIImage.road(name: (String(k_conPath) + String(showAgoString.prefix(4))))
        //: let sizex = imag.size
        let sizex = imag.size
    ...
    lazy var numLb: UILabel = {
        ...
        lb.font = UIFont.bagUniform(type: .Regular, fontSize: 9)
        //: return lb
        return lb
        //: }()
    }()
...
extension ContainerTableDisabledImplement {
    /// 更改选中状态
    //: func setChecked(checked: Bool) {
    func runWhite(checked: Bool) {
        ...
        if checked {
            ...
            bgView.layer.borderColor = UIColor.special().cgColor
    ...
    func create(currenmodel: TierBrush, giftType: GreenAttachImage) {
        //: model = currenmodel
        model = currenmodel
        //: giftIcon.setUrlImage(urlStr: model.imgPreview ?? "")
        giftIcon.fireIn(urlStr: model.imgPreview ?? "")
        //: priceBtn.setTitle("\(model.price)", for: .normal)
        priceBtn.setTitle("\(model.price)", for: .normal)
        //: selectedImageView.setUrlImage(urlStr: model.cornerMark, placeImg: nil)
        selectedImageView.fireIn(urlStr: model.cornerMark, placeImg: nil)
        ...
        let attributes = [NSAttributedString.Key.font: UIFont.bagUniform(type: .Regular, fontSize: 11),
...
extension ContainerTableDisabledImplement {
    ...
    func advanced() {
        ...
        bgView.backgroundColor = UIColor.someoneAgile()
