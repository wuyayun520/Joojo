...
class LocationCurve: TrainBrush {
    ...
    lazy var topView: GrainView = {
        //: let view = TalkingMomentPhotosTopView(frame: CGRect.zero, type: myType ?? .normal)
        let view = GrainView(frame: CGRect.zero, type: myType ?? .normal)
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var bottomView: RateComputeView = {
    ...
    lazy var usePhotoView: PhaseTailTap = {
        //: let v = TalkingSendIntimateInfoView(frame: CGRect.zero, type: .intimatePhoto)
        let v = PhaseTailTap(frame: CGRect.zero, type: .intimatePhoto)
        //: return v
        return v
        //: }()
    }()
...
extension LocationCurve {
    //: func crushBtnTool(modle: TalkingMomentModel) {
    func withinMoveAbove(modle: FinishEdge) {
        ...
        if modle.sex == nil {
            ...
            //: bottomView.isHidden = modle.sex==ChartShowSceneScientific.share.loginUserMode.sex
            bottomView.isHidden = modle.sex == ChartShowSceneScientific.share.loginUserMode.sex
        }
...
extension LocationCurve {
    ...
    private func beyondScientificQuality() {
