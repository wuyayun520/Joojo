...
extension Dictionary {
    ...
    public static func blackCreate(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func requireOpen(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.blackCreate(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
