...
struct ThresholdBeyond: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: DirectlyImpact?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [VerticalStorage]? // 相册
    ...
    var aiExtraInfo = ConsumeRemove() // AI模型
    //: var vipSkinId = 0
...
struct VerticalStorage: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func timingDiscover(compareTo: VerticalStorage) -> Bool {
        //: return
        return
...
struct ConsumeRemove: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
