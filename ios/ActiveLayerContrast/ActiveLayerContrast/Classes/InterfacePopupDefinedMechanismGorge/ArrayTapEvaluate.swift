...
fileprivate let noti_legacyId:[UInt8] = [0xa8,0xad,0xa8,0xb3,0x67,0xa2,0xae,0xa3,0xa4,0xb1,0x79,0x68,0x5f,0xa7,0xa0,0xb2,0x5f,0xad,0xae,0xb3,0x5f,0xa1,0xa4,0xa4,0xad,0x5f,0xa8,0xac,0xaf,0xab,0xa4,0xac,0xa4,0xad,0xb3,0xa4,0xa3]

fileprivate func propertyCap(maximum num: UInt8) -> UInt8 {
...
/*: "#292929" :*/
fileprivate let app_unlessId:String = "#2lengthlength9"

/*: "9999999" :*/
fileprivate let show_familyFormat:String = "9999999"

/*: "icon_coin" :*/
fileprivate let kAskString:[Character] = ["i","c","o","n","_","c","o","i","n"]

/*: "icon_gift_more_arrow" :*/
fileprivate let showAgentPushMessage:String = "icon_grin beau you"
fileprivate let kConversationPath:String = "MORE"
fileprivate let showStopSourceMsg:String = "ratew"

/*: "Hot" :*/
fileprivate let main_exKey:String = "Hotremove mage send"

/*: "VIP" :*/
fileprivate let user_wayData:[Character] = ["V","I","P"]

/*: "Bags" :*/
fileprivate let const_sensorOutsideValue:[Character] = ["B","a","g","s"]

/*: "icon_gift_num_arrow" :*/
fileprivate let dataComponentStr:String = "icon_gdestroy host oxygen builder one"
fileprivate let user_dynamicsFullData:String = "would tress micaum_arrow"

/*: "Send" :*/
fileprivate let mainFireData:String = "choose on rebuildSend"

/*: "nav_back_black_nor" :*/
fileprivate let dataRateNiteId:[Character] = ["n","a","v","_","b","a","c","k","_","b","l","a","c","k","_","n","o"]
fileprivate let kDuringNativeMsg:String = "regulate"

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let kLightlyName:[UInt8] = [0x31,0x20,0x6e,0x61,0x68,0x74,0x20,0x73,0x73,0x65,0x6c,0x20,0x65,0x62,0x20,0x74,0x6f,0x6e,0x6e,0x61,0x63,0x20,0x73,0x74,0x66,0x69,0x67,0x20,0x66,0x6f,0x20,0x72,0x65,0x62,0x6d,0x75,0x6e,0x20,0x65,0x68,0x54]

/*: "Please select a gift" :*/
fileprivate let appMarkLeastId:[Character] = ["P","l","e","a","s","e"," ","s","e","l","e"]
fileprivate let data_agoMainValue:[Character] = ["c","t"," ","a"," ","g","i","f","t"]

/*: "Please select an object" :*/
fileprivate let showTriggerKey:[Character] = ["P","l","e","a","s","e"," ","s","e","l","e","c","t"," ","a","n"]
fileprivate let kInstallData:[Character] = [" ","o","b","j","e","c","t"]

/*: "Select the desired gift to unlock" :*/
fileprivate let k_portedBeTitle:[UInt8] = [0xa0,0x96,0x9f,0x96,0x90,0x87,0xd3,0x87,0x9b,0x96,0xd3,0x97,0x96,0x80,0x9a,0x81,0x96,0x97,0xd3,0x94,0x9a,0x95,0x87,0xd3,0x87,0x9c,0xd3,0x86,0x9d,0x9f,0x9c,0x90,0x98]

private func nothingFace(transfer num: UInt8) -> UInt8 {
    return num ^ 243
}

/*: "Select object >" :*/
fileprivate let appSameDistanceTrustString:[Character] = ["S","e","l","e","c","t"," ","o","b","j","e","c","t"," ",">"]

/*: "It looks like there's nothing" :*/
fileprivate let app_visitValue:String = "capable undertake ilk place beatIt loo"
fileprivate let show_singleName:String = "ike thermount point"
fileprivate let data_writtenValue:String = "e\'s "
fileprivate let main_exTitle:String = "nothinphone"

/*: "FF75A4" :*/
fileprivate let user_denyStr:String = "FF75Afamily"

/*: "E570FF" :*/
fileprivate let noti_monsterNorCalculatePath:String = "Ecomponent70FF"

/*: "Ask for" :*/
fileprivate let data_processorUserKey:String = "Ask fproperly recommendation week destination"
fileprivate let constLogMsg:[Character] = ["o","r"]

/*: " Select %@ > " :*/
fileprivate let userCartPath:[Character] = [" ","S","e","l","e","c","t"," ","%","@"," "]
fileprivate let notiSignalTitle:[Character] = [">"," "]

/*: "All Numbers" :*/
fileprivate let userJustName:String = "All Numbexpose nana unknown"
fileprivate let main_contentPresentationTitle:String = "ERS"

/*: "View detailed description >" :*/
fileprivate let const_betweenRepublicId:[Character] = ["V","i","e","w"," ","d","e","t","a","i","l","e","d"," ","d","e","s","c","r","i","p","t","i","o","n"," "]
fileprivate let notiProgramName:String = ">"

/*: "9999" :*/
fileprivate let show_currentlyKey:[Character] = ["9","9","9","9"]

/*: "Custom" :*/
fileprivate let showPressExtendMsg:String = "Custommodify dark"

/*: "mf_coin" :*/
fileprivate let main_commonId:[Character] = ["m","f","_","c","o","i","n"]

/*: "showBagsRed" :*/
fileprivate let data_peopleSmileId:[Character] = ["s","h","o","w","B"]
fileprivate let app_disableTitle:[Character] = ["a","g","s","R","e","d"]
...
typealias SendFunctionBlock = (_ giftModel: TierBrush, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: TierBrush, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: TierBrush) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: TierBrush, _ num: String, _ model: RomanMagnitudeerval) -> Void
// 隐藏礼物面板Block
...
private let show_estimatedMsg = 44.0
//: let GiftScrollContentView_H = 252.0
let main_filterString = 252.0
//: private let pageControl_H = 7.0
private let noti_likeData = 7.0
//: private let bottomView_H = 44.0
private let dataListenerData = 44.0

//: class TalkingChatGiftView: UIView {
class ArrayTapEvaluate: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = show_estimatedMsg + main_filterString + noti_likeData + dataListenerData + const_controlData
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var titlesArr = [GreenAttachImage]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = GreenAttachImage.Hot
    ...
    init(frame: CGRect = .zero, style: PointExecute = .normal, titlesArr: [GreenAttachImage] = [.Hot, .Vip, .Bags]) {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: noti_legacyId.map{propertyCap(maximum: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: dataChainValue, width: show_licenseTitle, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (app_unlessId.replacingOccurrences(of: "length", with: "92")))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.oi(width: show_licenseTitle, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: show_licenseTitle, height: show_estimatedMsg)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (app_unlessId.replacingOccurrences(of: "length", with: "92")))
    ...
    private lazy var moneyBtn: KeepPurple = {
        //: let btn = TalkingButton()
        let btn = KeepPurple()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.bagUniform(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((show_familyFormat.capitalized), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.road(name: (String(kAskString))), for: .normal)
    ...
    private lazy var rechargeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(hard), for: .touchUpInside)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.road(name: (String(showAgentPushMessage.prefix(5)) + "gift_" + kConversationPath.lowercased() + "_arr" + showStopSourceMsg.replacingOccurrences(of: "rate", with: "o")))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.doingShelter(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.doingShelter(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        hot.register(ContainerTableDisabledImplement.self, forCellWithReuseIdentifier: ContainerTableDisabledImplement.className())
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: TierInfrastructure = //: return hotGiftCollectionView.collectionViewLayout as! TierInfrastructure
        hotGiftCollectionView.collectionViewLayout as! TierInfrastructure
    //: }()
    ...
    private lazy var titleScrollView: ComparePush = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(main_exKey.prefix(3))).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((String(user_wayData)).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(const_sensorOutsideValue)).localized)
            }
        }
        ...
        let scrollview = ComparePush(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(show_estimatedMsg)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if TitlePer.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = MacroDefine.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = CharacteristicSine.observeData() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !StageMargin.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var sendAreaView: UIView = {
        ...
        view.layer.borderColor = UIColor.special().cgColor
    ...
    private lazy var giftNumButton: KeepPurple = {
        ...
        btn.setImage(UIImage.road(name: (String(dataComponentStr.prefix(6)) + "ift_n" + String(user_dynamicsFullData.suffix(8)))), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(list), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.bagUniform(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.special()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(mainFireData.suffix(4))).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(onTouchSendGiftBtn), for: .touchUpInside)
        btn.addTarget(self, action: #selector(searcherOld), for: .touchUpInside)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: dataChainValue - CGFloat(keyborHeight) - 44, width: show_licenseTitle, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.road(name: (String(dataRateNiteId) + kDuringNativeMsg.replacingOccurrences(of: "regulate", with: "r"))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.asTimingPlain(color: .special(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(mainFireData.suffix(4))).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] event in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.bury(showMsg: String(bytes: kLightlyName.reversed(), encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.bury(showMsg: (String(appMarkLeastId) + String(data_agoMainValue)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.bury(showMsg: (String(showTriggerKey) + String(kInstallData)).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = GreenAttachImage(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.scene(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: TierBrush = dataArr[index] as! TierBrush
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(notice(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(subsequent(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(decideWithConsumptionDomain(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: k_portedBeTitle.map{nothingFace(transfer: $0)}, encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(flexible), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(appSameDistanceTrustString)).localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(beyondPool), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.font = UIFont.bagUniform(type: .Regular, fontSize: 16)
        //: lab.text = "It looks like there's nothing".localized
        lab.text = (String(app_visitValue.suffix(6)) + "ks l" + String(show_singleName.prefix(8)) + data_writtenValue + main_exTitle.replacingOccurrences(of: "phone", with: "g")).localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.managerMouse(colors: [UIColor(hex: (user_denyStr.replacingOccurrences(of: "family", with: "4")))!.cgColor, UIColor(hex: (noti_monsterNorCalculatePath.replacingOccurrences(of: "component", with: "5")))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.bagUniform(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(data_processorUserKey.prefix(5)) + String(constLogMsg)).localized, for: .normal)
...
extension ArrayTapEvaluate {
    ...
    @objc func analyze() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: dataChainValue, width: show_licenseTitle, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func when() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: dataChainValue - self.contentHeight, width: show_licenseTitle, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func flexible() {
        //: let index = self.giftSelectedModel.lastHotIndexPath.row
        let index = self.giftSelectedModel.lastHotIndexPath.row
        //: guard let dataType = GiftDataType(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        guard let dataType = GreenAttachImage(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.scene(dataType: dataType)
    ...
    @objc func beyondPool() {
        //: meneView = DropDownMemberMenuView.init(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
        meneView = ImplementCharacter(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func missEnable() {
        //: dismissView()
        analyze()
        //: BeforeAssociate.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        BeforeAssociate.share.successfullyHi(webViewType: .luckyBlindBox)
    }
...
extension ArrayTapEvaluate {
    ...
    func cropManual(pkgItemsetId: String, num: Int) {
        ...
        DispatchQueue.main.async {
            ...
            StageMargin.share.comprehensiveTar(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.distributionWeight(force: true)
        }
    }
}
...
extension ArrayTapEvaluate: TakeOrange {
    //: func didClickSelectedRow(model: TalkingChatRoomMemberModel) {
    func liveCalculate(model: RomanMagnitudeerval) {
        //: self.chatRoomgiftSelectedMemberModel = model
        self.chatRoomgiftSelectedMemberModel = model
        //: seleteObjectBtn.setTitle(" Select %@ > ".localizedArguments(model.nickname), for: .normal)
        seleteObjectBtn.setTitle((String(userCartPath) + String(notiSignalTitle)).skipLive(model.nickname), for: .normal)
    }
    ...
    func maintain() {
        ...
        if model.nickname == (String(userJustName.prefix(8)) + main_contentPresentationTitle.lowercased()).localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! RomanMagnitudeerval
    ...
    func field(title: String) {
        ...
        let str = (String(const_betweenRepublicId) + notiProgramName.capitalized).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension ArrayTapEvaluate: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func scene(dataType: GreenAttachImage) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return StageMargin.share.actualFor(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func boardLimit() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return StageMargin.share.smartTo()
    }
    ...
    func reliability(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == EvolutionBy.myStery.rawValue)
        }
    ...
    @objc fileprivate func notice(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (String(show_currentlyKey))
            //: } else {
        } else {
    ...
    @objc func decideWithConsumptionDomain(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: dataChainValue - CGFloat(keyborHeight) - 44, width: show_licenseTitle, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func subsequent(notification: NSNotification) {
    ...
    func tier() {
        ...
        let sendingItems = boardLimit()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(outsideDirect(index: i))
//            let giftNumArrModel: BackgroundPlatform = sendingItems[i] as! BackgroundPlatform
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((String(showPressExtendMsg.prefix(6))).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.PetImplementation.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = NextTable.connectionMakeValid(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func openSpring() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? ContainerTableDisabledImplement
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.bag(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = GreenAttachImage(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = scene(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = ContainerTableDisabledImplement.className()
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! ContainerTableDisabledImplement
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = GreenAttachImage(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = scene(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: TierBrush = dataArr[indexPath.row] as! TierBrush
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.create(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.runWhite(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = GreenAttachImage(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = scene(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == EvolutionBy.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == EvolutionBy.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == EvolutionBy.myStery.rawValue && style == .normal {
            ...
            var sendIndex = edgeMini(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = challenge(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            pin(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: ContainerTableDisabledImplement = giftSelectedModel.lastHotCell as! ContainerTableDisabledImplement
                //: cell.setChecked(checked: false)
                cell.runWhite(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: ContainerTableDisabledImplement = self.hotGiftCollectionView.cellForItem(at: indexPath) as! ContainerTableDisabledImplement
            //: currentCell.setChecked(checked: true)
            currentCell.runWhite(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.betweenCountervalMomentum(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.scene(dataType: self.currType)
    ...
    func distributionWeight(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + show_licenseTitle
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < show_licenseTitle ? show_licenseTitle : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / show_licenseTitle - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(show_licenseTitle) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = GreenAttachImage.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = StageMargin.share.finishEvery(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.drawing(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && ChartShowSceneScientific.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == GreenAttachImage.Hot && self.style == .normal && ChartShowSceneScientific.share.loginUserMode.sex == SharedOdd.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == EvolutionBy.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                field(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func para() {
        ...
        self.giftSelectedModel = VisibleDocument()
...
// MARK: - AdvancedDistance

//: extension TalkingChatGiftView: DropDownMenuViewDelegate {
extension ArrayTapEvaluate: AdvancedDistance {
    ...
    func galleryDown(index: Int, title: String) {
        ...
        pin(index: index + 1, title: title)
    }

    //: func  didClickSelectedCellRow(index: Int, title: String) {
    func pin(index: Int, title: String) {
        //: let numberOfGift = numberOfGiftForIndex(index: index)
        let numberOfGift = outsideDirect(index: index)
        //: if numberOfGift>0 {
        if numberOfGift > 0 {
            ...
            popView?.bot(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.crucial(view: self.window!)
    ...
    func outsideDirect(index: Int) -> Int {
        //: let sendingItems = giftSendItems()
        let sendingItems = boardLimit()
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: BackgroundPlatform = sendingItems[index] as! BackgroundPlatform
    ...
    func edgeMini(num: Int) -> Int {
        //: var index = 0
        var index = 0
        //: for i in 0..<giftSendItems().count {
        for i in 0 ..< boardLimit().count {
            //: let model: TalkingGiftNumArrModel = giftSendItems()[i] as! TalkingGiftNumArrModel
            let model: BackgroundPlatform = boardLimit()[i] as! BackgroundPlatform
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func challenge(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > boardLimit().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension ArrayTapEvaluate {
    ...
    private func line() {
        ...
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: show_licenseTitle, height: dataChainValue - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(analyze)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(main_filterString)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(show_licenseTitle)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(show_licenseTitle - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(noti_likeData)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(dataListenerData)
        }
    ...
    private func substantialSound() {
        //: ChartShowSceneScientific.share.loginUserMode.rx
        ChartShowSceneScientific.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (String(main_commonId)))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.reliability(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        StageMargin.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(data_peopleSmileId) + String(app_disableTitle)))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                StageMargin.share.per(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: ChartShowSceneScientific.share.loginUserMode.mf_coin)
                    self.reliability(needReload: true, mf_coin: ChartShowSceneScientific.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
