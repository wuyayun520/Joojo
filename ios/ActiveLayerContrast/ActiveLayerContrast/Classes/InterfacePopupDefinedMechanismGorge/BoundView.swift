...
fileprivate let appConstantStr:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#AAAAAA" :*/
fileprivate let user_migrationWatchMsg:String = "#AAAAAAinstruction version quick sample exception"

/*: "btn_chatsettings_unchoice" :*/
fileprivate let main_resistanceDecisionFormat:[Character] = ["b","t","n","_","c","h","a","t","s","e","t","t","i","n","g","s","_","u"]
fileprivate let user_portraitMsg:String = "NCHOICE"

/*: "btn_chatsettings_choiced" :*/
fileprivate let appSourceProviderFormat:String = "btn_cexample graphic orang empty board"
fileprivate let k_packTitle:String = "eediti"
fileprivate let constRangeId:String = "oireasoned"

/*: "Top" :*/
fileprivate let main_askUrl:[Character] = ["T","o","p"]

/*: "Save" :*/
fileprivate let show_sufficientUnderData:String = "Savetag actual tier"

/*: "Cancel" :*/
fileprivate let kMedalId:String = "today itemCancel"
...
class BoundView: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: appConstantStr.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let height = actualWidth(w: 475) + const_controlData
        //: let v = UIView(frame: CGRect(x: 0, y: ScreenHeight-height, width: ScreenWidth, height: height))
        let v = UIView(frame: CGRect(x: 0, y: dataChainValue - height, width: show_licenseTitle, height: height))
        //: v.backgroundColor = .white
        v.backgroundColor = .white
        //: v.Corner(width: v.width, height: v.height, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        v.oi(width: v.width, height: v.height, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var textBgView: UIView = {
        ...
        v.backgroundColor = UIColor.livingRank()
    ...
    private lazy var limitLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(user_migrationWatchMsg.prefix(7))))
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var topBtn: KeepPurple = {
        ...
        btn.setImage(UIImage.road(name: (String(main_resistanceDecisionFormat) + user_portraitMsg.lowercased())), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "btn_chatsettings_choiced"), for: .selected)
        btn.setImage(UIImage.road(name: (String(appSourceProviderFormat.prefix(5)) + "hats" + k_packTitle.replacingOccurrences(of: "edit", with: "tt") + "ngs_ch" + constRangeId.replacingOccurrences(of: "reason", with: "c"))), for: .selected)
        ...
        btn.setTitle((String(main_askUrl)).localized, for: .normal)
        //: btn.spaceBetweenTitleAndImage = 6
        btn.spaceBetweenTitleAndImage = 6
        //: btn.addTarget(self, action: #selector(topButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(meBrown), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var saveBtn: UIButton = {
        ...
        btn.setTitle((String(show_sufficientUnderData.prefix(4))).localized, for: .normal)
    ...
    private lazy var cancelBtn: UIButton = {
        ...
        btn.setTitle((String(kMedalId.suffix(6))).localized, for: .normal)
...
extension BoundView: YYTextViewDelegate {
...
extension BoundView {
    ...
    @objc private func ad() {
        ...
        NameProjection.splitBy(content: textView.text, isTop: isTop, toUid: targetId) {
            //: succeed, _, _ in
            succeed, _, _ in
    ...
    func club(_ content: String, isTop: Int, toUid: String) {
        //: targetId = toUid
        targetId = toUid
...
extension BoundView {
    ...
    private func suspendDisabled() {
        //: frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight)
        frame = CGRect(x: 0, y: 0, width: show_licenseTitle, height: dataChainValue)
