...
class OutsideSmart: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        nearWooMortal(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        nearWooMortal(placeholder: nil, placeholderColor: nil)
    }
}
...
extension OutsideSmart {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func nearWooMortal(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(TaskContainer().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(TaskContainer().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-TaskContainer().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: WhiteCounterval().top, left: WhiteCounterval().left, bottom: WhiteCounterval().bottom, right: WhiteCounterval().right)
...
extension OutsideSmart: UITextViewDelegate {
