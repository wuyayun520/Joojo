...
fileprivate let dataCurTitle:[UInt8] = [0x79,0x7e,0x79,0x64,0x38,0x73,0x7f,0x74,0x75,0x62,0x2a,0x39,0x30,0x78,0x71,0x63,0x30,0x7e,0x7f,0x64,0x30,0x72,0x75,0x75,0x7e,0x30,0x79,0x7d,0x60,0x7c,0x75,0x7d,0x75,0x7e,0x64,0x75,0x74]

/*: "btn_dynamic_stop_nor" :*/
fileprivate let showSternApartmentString:[Character] = ["b","t","n","_","d"]
fileprivate let k_protectionPath:String = "maximum appropriate available tempynamic_"
fileprivate let userStatusStr:String = "stop_norsquare successfully skirt shake fore"
...
class TitleureView: UICollectionViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: dataCurTitle.map{$0^16}, encoding: .utf8)!)
    }
    ...
    lazy var bgImgView: UIImageView = {
        ...
        imgV.image = UIImage.alongPatter()
    ...
    private lazy var playimageView: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.road(name: (String(showSternApartmentString) + String(k_protectionPath.suffix(7)) + String(userStatusStr.prefix(8)))))
        //: return imag
        return imag
        //: }()
    }()
...
extension TitleureView {
    //: func configModel(videoUrl: String, imgUrl: String ) {
    func old(videoUrl: String, imgUrl: String) {
        //: self.videoUrl = videoUrl
        self.videoUrl = videoUrl
        //: self.coverView.setUrlImage(urlStr: imgUrl)
        self.coverView.fireIn(urlStr: imgUrl)
    }
    ...
    func remarkDoing() {
        ...
        self.player.week(url: videoUrl, view: self.coverView)
...
extension TitleureView: NativeCalculate {
