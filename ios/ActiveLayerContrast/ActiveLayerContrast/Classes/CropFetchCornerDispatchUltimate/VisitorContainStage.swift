...
fileprivate let mainPanelData:[UInt8] = [0x5a,0x5d,0x5a,0x47,0x1b,0x50,0x5c,0x57,0x56,0x41,0x9,0x1a,0x13,0x5b,0x52,0x40,0x13,0x5d,0x5c,0x47,0x13,0x51,0x56,0x56,0x5d,0x13,0x5a,0x5e,0x43,0x5f,0x56,0x5e,0x56,0x5d,0x47,0x56,0x57]

/*: "icon_chat_start" :*/
fileprivate let dataPingHolderMessage:[Character] = ["i","c","o","n","_","c","h","a","t","_","s","t","a","r"]
fileprivate let data_suspendInsteadMsg:[Character] = ["t"]

/*: "#752FE9" :*/
fileprivate let dataStatueValue:String = "#752FE9pick normally nim enjoy policy"

/*: "#F5F5F5" :*/
fileprivate let dataBitUrl:[Character] = ["#","F"]
fileprivate let k_entityMsg:String = "5F5F5manager spell yet integrity sample"

/*: "btn_feed_dianzan_nor" :*/
fileprivate let dataEmbarrassData:[UInt8] = [0xf7,0xe1,0xfb,0xca,0xf3,0xf0,0xf0,0xf1,0xca,0xf1,0xfc,0xf4,0xfb,0xef,0xf4,0xfb,0xca,0xfb,0xfa,0xe7]

/*: "btn_feed_reply_nor" :*/
fileprivate let constOrangName:String = "btn_host active play rating chemist"
fileprivate let mainPromiseValue:String = "_reply_nadministrative tee domain range inner"
fileprivate let constKeepStr:String = "successfullyr"
...
class VisitorContainStage: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: mainPanelData.map{$0^51}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.road(name: (String(dataPingHolderMessage) + String(data_suspendInsteadMsg)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(dataStatueValue.prefix(7))))
    ...
    private lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.pass(fontSize: 12)
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(dataBitUrl) + String(k_entityMsg.prefix(5))))
...
extension VisitorContainStage {
    /// 刷新cell
    //: func refreshCell(_ model: TalkingRemindListModel) {
    func crushDespiteCanvas(_ model: AmongSecond) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.moreThen(urlStr: model.headPic, placeImg: UIImage.alongPatter())
        ...
        previewImgView.fireIn(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: dataEmbarrassData.map{$0^149}, encoding: .utf8)! : (String(constOrangName.prefix(4)) + "feed" + String(mainPromiseValue.prefix(8)) + constKeepStr.replacingOccurrences(of: "successfully", with: "o"))
        //: statusIcon.image = UIImage.BundleImageNamed(name: typeImgStr)
        statusIcon.image = UIImage.road(name: typeImgStr)
...
extension VisitorContainStage {
    ...
    private func advancedUndertake() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((show_licenseTitle - 128) / 2)
        }
