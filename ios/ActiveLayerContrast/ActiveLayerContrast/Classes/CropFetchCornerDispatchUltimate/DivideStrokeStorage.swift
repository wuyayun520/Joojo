...
fileprivate let kRelationMsg:[UInt8] = [0x8c,0x8b,0x8c,0x91,0xcd,0x86,0x8a,0x81,0x80,0x97,0xdf,0xcc,0xc5,0x8d,0x84,0x96,0xc5,0x8b,0x8a,0x91,0xc5,0x87,0x80,0x80,0x8b,0xc5,0x8c,0x88,0x95,0x89,0x80,0x88,0x80,0x8b,0x91,0x80,0x81]

/*: "icon_mini_voice_end" :*/
fileprivate let mainTabKey:String = "icintegrityn"
fileprivate let noti_sustainableChallengeData:String = "todayoic"

/*: "#F95151" :*/
fileprivate let user_replaceQuantityroMsg:String = "#F95151lay fixed ilk"

/*: "End of call" :*/
fileprivate let appSeekGeneralTitle:[Character] = ["E","n","d"," ","o","f"," ","c","a"]
fileprivate let showPlatMessage:String = "eheh"

/*: "img_home_shadow_icon" :*/
fileprivate let notiErrorFormat:String = "img_hsufficient corner heart"
fileprivate let showDatabaseName:String = "tally ported con yahadow_i"
fileprivate let appNousString:[Character] = ["c","o","n"]
...
class DivideStrokeStorage: AboutView {
    // 小窗口通话状态
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: kRelationMsg.map{$0^229}, encoding: .utf8)!)
    }
    ...
    private lazy var statusIcon: UIImageView = {
        ...
        img.image = UIImage.road(name: (mainTabKey.replacingOccurrences(of: "integrity", with: "o") + "_mini_" + noti_sustainableChallengeData.replacingOccurrences(of: "today", with: "v") + "e_end"))
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(user_replaceQuantityroMsg.prefix(7))))
        ...
        lab.text = (String(appSeekGeneralTitle) + showPlatMessage.replacingOccurrences(of: "eh", with: "l")).localized
    ...
    private lazy var shadowImg: UIImageView = {
        ...
        img.image = UIImage.road(name: (String(notiErrorFormat.prefix(5)) + "ome_s" + String(showDatabaseName.suffix(7)) + String(appNousString)))
...
extension DivideStrokeStorage {
    /// 构建视频小窗口
    //: static func buildVideoMiniView() -> TalkingVideoMiniView {
    static func weekScript() -> DivideStrokeStorage {
        //: let view = TalkingVideoMiniView(frame: .zero)
        let view = DivideStrokeStorage(frame: .zero)
