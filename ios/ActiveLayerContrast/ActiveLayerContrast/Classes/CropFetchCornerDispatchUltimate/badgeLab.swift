...
class LevelScenario: UILabel {
    ...
    private func ye() {
        ...
        layer.backgroundColor = UIColor.bubbleStrategy().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.bagUniform(type: .Medium, fontSize: 11)
