...
/*: "&sr=6" :*/
fileprivate let data_reachKey:String = "&sr=6significant concrete pick problem"
...
enum MediaBrown: String, CaseIterable {
...
class DetailLog: NSObject {
    ...
    class func chain(urlType: FlexProperty) -> String {
        //: var url = ChartShowSceneScientific.share.appConfigMode.urlH5Domain
        var url = ChartShowSceneScientific.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(ChartShowSceneScientific.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : ChartShowSceneScientific.share.appUserConfigMode.fullRechargePage)
            url.append(ChartShowSceneScientific.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : ChartShowSceneScientific.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(ChartShowSceneScientific.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : ChartShowSceneScientific.share.appUserConfigMode.halfRechargePage)
            url.append(ChartShowSceneScientific.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : ChartShowSceneScientific.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = ChartShowSceneScientific.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = ChartShowSceneScientific.share.appUserConfigMode.halfRechargePage.appending((String(data_reachKey.prefix(5))))
            //: url.append(ChartShowSceneScientific.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(ChartShowSceneScientific.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
