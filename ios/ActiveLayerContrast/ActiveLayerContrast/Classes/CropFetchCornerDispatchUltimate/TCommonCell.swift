...
@objcMembers public class ChartEmptyPop: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func anonymousDirect(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class ErrorBound: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: ChartEmptyPop?
    ...
    @objc dynamic public func grain(with data: ChartEmptyPop) {
        //: self.data = data
        self.data = data
    }
} 
