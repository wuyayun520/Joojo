...
fileprivate let showAlreadyStr:[UInt8] = [0x70,0x75,0x70,0x7b,0x2f,0x6a,0x76,0x6b,0x6c,0x79,0x41,0x30,0x27,0x6f,0x68,0x7a,0x27,0x75,0x76,0x7b,0x27,0x69,0x6c,0x6c,0x75,0x27,0x70,0x74,0x77,0x73,0x6c,0x74,0x6c,0x75,0x7b,0x6c,0x6b]

fileprivate func providerPresentUniform(actual num: UInt8) -> UInt8 {
...
class DetailView: UIView {
    ...
    class func makeTing(_ frame: CGRect) -> UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: showAlreadyStr.map{providerPresentUniform(actual: $0)}, encoding: .utf8)!)
    }
