...
fileprivate let dataTimingValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class Format: AboutView {
    ...
    override init(frame: CGRect) {
        ...
        countryPrice()
        //: addTapGesture()
        appCompleteAgentHide()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: dataTimingValue.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var renderView: UIView = { // 视频渲染视图
        ...
        view.backgroundColor = .sharkHighlightMaintain()
        //: view.layer.cornerRadius = 8
        view.layer.cornerRadius = 8
        //: view.layer.masksToBounds = true
        view.layer.masksToBounds = true
...
extension Format: TXLivePlayListener {
