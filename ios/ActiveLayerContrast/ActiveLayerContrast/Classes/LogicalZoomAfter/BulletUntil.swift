...
@objcMembers public class BulletUntil: NSObject {
    ...
    class func taJudge() -> BulletUntil {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = BulletUntil.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func connectFlow() -> BulletUntil {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = BulletUntil.init(isIncomming: false)
        //: return layout
        return layout
    }
