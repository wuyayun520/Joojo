...
@objcMembers open class TitlePer: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = TitlePer()
    //: private(set) var currLanguage: String = MacroDefine.getSystemLangCode()
    private(set) var currLanguage: String = CharacteristicSine.enableCondemnMore()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func stageThree(_ language: String) {
...
extension String {
    ...
    public func skipLive(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = DocumentWhite.default.languagePath
