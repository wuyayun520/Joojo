...
fileprivate let notiPrimaryData:[Character] = ["b","t","n","_","m","e","_","b","a","c","k","_","c"]
fileprivate let appAddressPath:String = "ontellnue"

/*: "init(coder:) has not been implemented" :*/
fileprivate let notiPullData:[UInt8] = [0x49,0x4e,0x49,0x54,0x8,0x43,0x4f,0x44,0x45,0x52,0x1a,0x9,0x0,0x48,0x41,0x53,0x0,0x4e,0x4f,0x54,0x0,0x42,0x45,0x45,0x4e,0x0,0x49,0x4d,0x50,0x4c,0x45,0x4d,0x45,0x4e,0x54,0x45,0x44]

private func naturalJust(last num: UInt8) -> UInt8 {
    return num ^ 32
}
...
class SensorProgress: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(asApproveConsumer), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(responseWithTranslation), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: MissionField)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(notiPrimaryData) + appAddressPath.replacingOccurrences(of: "tell", with: "ti"))
        }
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: notiPullData.map{naturalJust(last: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func thereforInfrastructure(title: String, isTouch: Bool) {
