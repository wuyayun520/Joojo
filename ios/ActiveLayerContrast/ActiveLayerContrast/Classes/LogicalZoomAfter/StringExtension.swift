...
/*: "ZUhWdWQzVnNiM1ps" :*/
fileprivate let show_norTapMsg:String = "investigate evaluate mode appropriateZUhW"
fileprivate let mainEvaluateValue:String = "return work inside outfitnNiM1ps"

/*: "OrKulDHBYyjUHZTy1sS7dw==" :*/
fileprivate let k_panelData:String = "OrKulDcollect ceiling"
fileprivate let constMeaningTitle:[Character] = ["H","B","Y","y","j","U","H","Z","T","y","1","s","S","7","d","w","=","="]

/*: "null" :*/
fileprivate let userWhyPath:String = "nuleast"

/*: "(null)" :*/
fileprivate let kMapDecisionData:[Character] = ["(","n","u","l","l",")"]

/*: "nil" :*/
fileprivate let userStrategyUrl:String = "nsubl"

/*: "<null>" :*/
fileprivate let dataThroughMasterPath:String = "<null>here odd tap"

/*: "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMnopQRSTUVWXYZ0123456789" :*/
fileprivate let main_applicationBellyUrl:[UInt8] = [0x39,0x38,0x37,0x36,0x35,0x34,0x33,0x32,0x31,0x30,0x5a,0x59,0x58,0x57,0x56,0x55,0x54,0x53,0x52,0x51,0x70,0x6f,0x6e,0x4d,0x4c,0x4b,0x4a,0x49,0x48,0x47,0x46,0x45,0x44,0x43,0x42,0x41,0x7a,0x79,0x78,0x77,0x76,0x75,0x74,0x73,0x72,0x71,0x70,0x6f,0x6e,0x6d,0x6c,0x6b,0x6a,0x69,0x68,0x67,0x66,0x65,0x64,0x63,0x62,0x61]

/*: "加密参数=  :*/
fileprivate let constTeeId:[Character] = ["加","密","参","数","="," "]

/*: "解密结果=  :*/
fileprivate let k_storageMsg:[Character] = ["解","密","结","果","="," "]
...
let show_skinAcrossMessage = (String(show_norTapMsg.suffix(4)) + "dWQzV" + String(mainEvaluateValue.suffix(7)))

//: let UrlDomin = "OrKulDHBYyjUHZTy1sS7dw=="
let notiSaltFinishId = (String(k_panelData.prefix(6)) + String(constMeaningTitle))
...
extension String {
    ...
    var isEmptyString: Bool {
        ...
        guard self != (userWhyPath.replacingOccurrences(of: "least", with: "ll")) else { return true }
        //: guard self != "(null)" else { return true }
        guard self != (String(kMapDecisionData)) else { return true }
        //: guard self != "nil" else { return true }
        guard self != (userStrategyUrl.replacingOccurrences(of: "sub", with: "i")) else { return true }
        //: guard self != "<null>" else { return true }
        guard self != (String(dataThroughMasterPath.prefix(6))) else { return true }
    ...
    func cellBloc(_ matchStr: String) -> [NSRange] {
...
extension String {
    ...
    static func screenFor(length: Int) -> String {
        //: let letters: NSString = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMnopQRSTUVWXYZ0123456789"
        let letters: NSString = String(bytes: main_applicationBellyUrl.reversed(), encoding: .utf8)! as NSString
    ...
    static func galleryCommit(str: String, from: Int, to: Int) -> String {
