...
@objcMembers class ConstraintModel: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: TellPress?
    //: var gift: TalkingMsgGiftModel?
    var gift: TextPop?
    //: var user: TalkingMsgUserModel?
    var user: VisitorKindImplementation?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: TypicalAspect?
...
class TellPress: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class VisitorKindImplementation: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class TypicalAspect: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class TextPop: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
